...
def backups():
    ...
    o("mkdir backups")
    o("chmod 777 backups/")
    o("mkdir backups/important")
    o("chmod 777 backups/important")
    o("cp /etc/shadow* backups/important")
    o("cp /etc/passwd* backups/important")
    o("cp /etc/group backups/important")
    o("cp /etc/group- backups/important")
    o("cp -ar /etc/pam.d/ backups/important")
    o("cp /etc/login.defs backups/important")
    o("cp /etc/sysctl.conf backups/important")
    o("cp /etc/cron.allow backups/important")
    o("cp /etc/cron.deny backups/important")
    o("cp /etc/at.deny backups/important")
    o("cp -ar /etc/cron.d/ backups/important")
    o("cp -ar /var/spool/cron/ backups/important")
    o("cp /etc/sudoers backups/important")
...
def local_security_policies():
    ...
    o("sysctl -p external_files/sysctl-conf.txt")
    printTime("Sysctl Security Polices have been set!")
